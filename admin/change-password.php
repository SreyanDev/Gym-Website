  ...
  <body class="app sidebar-mini rtl">
   ...
   <?php include 'include/header.php'; ?>
    ...
    <?php include 'include/sidebar.php'; ?>
      <marquee onMouseOver="this.stop()" style="color: #e92f33;" onMouseOut="this.start()">Discounts now! Discounts now! Checkout!<a target="_blank" href="https://www.youtube.com/@codecampbdofficial">Code Camp BD</a> permission if needed!</marquee>
